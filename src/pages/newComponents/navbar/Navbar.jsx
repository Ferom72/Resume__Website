...
function Navbar() {
  ...
  function handleMessage(message) {
    if (message !== "") {
      navigator.clipboard.writeText("ferom2093@gmail.com").then(() => {
        toast.success(message);
      });
    }
  }

  function handleRidirect(location) {
    if (location === "Git") {
      window.open("https://github.com/Ferom72?tab=repositories");
    } else if (location === "Linked") {
      window.open("https://www.linkedin.com/in/felipe-romero-b31a31192/");
    }
  }

  return (
    <div className="newnavbar__container">
      <div className="navbar__headerContainer">
        <motion.div className="draw__container">
          <motion.svg
            width="100"
            height="70"
            viewBox="0 0 226 130"
      ...
      <div className="navbar__linksContainer">
        <div className="links__container">
          <BiLogoGmail
            size={30}
            onClick={() => handleMessage("Email has been copied")}
          />
        </div>
        <div className="links__container">
          <FaLinkedin size={30} onClick={() => handleRidirect("Linked")} />
        </div>
        <div className="links__container">
          <IoLogoGithub size={30} onClick={() => handleRidirect("Git")} />
        </div>
      </div>
    </div>
  );
